...
const ContactSection = ({ contactData, addGap }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://skilledworkerscloud.co.uk//website-api/api/controller/form.php",
        {
          method: "POST",
          headers: {
  ...
  return (
    <>
      ...
      <section
        className={`contact-section ${addGap ? "section-padding-3 padding-bottom" : "section-padding"} fix`}
        id="contact"
      >
              ...
              <div className="col-xl-4 col-md-6">
                <div className="contact-info-box style1">
                  <div className="contact-content">
                    ...
                    <div className="title">
                      {" "}
                      {contactData?.address_heading}{" "}
                    </div>
                    <a className="text" href="#">
                      {contactData?.contact_office}
                    </a>
                  </div>
                </div>
              </div>
                  ...
                  <div className="contact-content">
                    ...
                    <a
                      ...
                      dangerouslySetInnerHTML={{
                        __html: contactData?.contact_email,
                      }}
                    />
                  </div>
                </div>
                ...
                <div className="contact-info-box style1">
                  <div className="contact-content">
                    ...
                    <p
                      className="text"
                      dangerouslySetInnerHTML={{
                        __html: contactData?.contact_phone,
                      }}
                    ></p>
                  </div>
                </div>
        ...
        <div class="container">
          <div class="contact-form-wrapper style1">
            {/* <div class="row gy-5 gx-60"> */}
              ...
              {/* <div className="col-xl-6 map-h">
                <div
                  className="contact-map d-flex align-items-center justify-content-center"
                  style={{
                    minHeight: "420px",
                    background: "#f5f7fb",
                    borderRadius: "10px",
                ...
                >
                  <div style={{ textAlign: "center", padding: "20px" }}>
                    ...
                    <p style={{ color: "#6b7280", margin: 0 }}>
                      Location map will be available here shortly.
                    </p>
                  </div>
                </div>
              </div> */}
                  ...
                  <div class="contact-form style1">
                    ...
                    <p class="desc d-flex justify-content-center">
                      {contactData?.paragraph1 ??
                        "Have questions or need support? Fill out the form below and our team will get in touch with you shortly"}
                    </p>

                    <form onSubmit={handleSubmit} className="mt-4">
                      <div class="row g-4">
                        <FadeInUp as="div" delay={0.3} className="col-lg-6">
                          <div class="form-clt">
                            {/* <span>Your name* </span> */}
                            <input
                              type="text"
                        ...
                        <FadeInUp as="div" delay={0.5} className="col-lg-6">
                          <div class="form-clt">
                        ...
                        <FadeInUp as="div" delay={0.7} className="col-lg-12">
                          <div class="form-clt">
